...
- [Prompt](../prompt/)：理解指令结构和输出约束。
- [Tool Calling](../langchain/05_tools/)：理解模型如何申请调用外部函数。
- [MCP](../mcp/)：理解工具和数据源如何标准化接入。
- [Deep Agents](../deepagents/)：理解长任务 Agent 为什么需要规划、文件系统和子代理。
...
- MCP 教程：[../mcp](../mcp/)
- Deep Agents 教程：[../deepagents](../deepagents/)
