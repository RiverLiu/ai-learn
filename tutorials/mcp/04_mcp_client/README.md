...
```bash
uv run tutorials/mcp/04_mcp_client/server_http.py            # 终端 1：监听 127.0.0.1:8000/mcp
uv run tutorials/mcp/04_mcp_client/client_http.py http       # 终端 2
```

方式三：旧版 SSE：

```bash
uv run tutorials/mcp/04_mcp_client/server_http.py sse        # 终端 1：监听 127.0.0.1:8000/sse
uv run tutorials/mcp/04_mcp_client/client_http.py sse        # 终端 2
```
