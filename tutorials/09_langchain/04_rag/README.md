...
本章把 [rag 教程](../../07_rag/)的手写流水线原样搬上 LangChain：**每一步对应一个框架组件**，
...
```bash
uv run tutorials/09_langchain/04_rag/main.py "专业版多少钱？学生有优惠吗？"
uv run tutorials/09_langchain/04_rag/main.py "离线编辑冲突了怎么办"
```
