...
与 tutorials/rag/01_embeddings/main.py 做的是同一个实验（查询 + 候选句、余弦相似度排序），
...
def print_install_guide():
    ...
    print("  rm -f tutorials/rag/03_vector_store/rag_index.npz tutorials/rag/03_vector_store/rag_index.json")
    print("  uv run tutorials/rag/03_vector_store/main.py")
